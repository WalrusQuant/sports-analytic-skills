#!/usr/bin/env python3
"""Save a home-team point differential histogram for NFL seasons."""
...
def main() -> int:
    ...
    p.add_argument("--out", default="data/home_margin_hist.png")
    args = p.parse_args()
    ...
    ax.set_title(f"Home team point differential (n={len(home)}, seasons={args.seasons})")
